"""- Demonstrate aggregation functions (Count, Sum, Group by, Distinct, Filter Column & Rows, Checks 
like NULL, number range, string column with regex, e.g., email ID, SSN, State list"""
